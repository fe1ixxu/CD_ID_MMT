...
LANG_PAIRS='nso-eng,run-eng,ssw-eng,ind-eng,msa-eng,isl-eng,nob-eng,fao-eng,slv-eng,tgl-eng,cat-eng,glg-eng,fur-eng,ltz-eng,lim-eng'
...
export WANDB_NAME=${SLURM_JOB_ID}_${SIZE}_new_id_xx_eng_${TASKS}_${TYPE}_alpha${ALPHA}_mask${MASK_RATIO}_RESAMPLE_${RESAMPLE}_${ID_MMT}_temp_${TEMP}_${SHARED}_${BLOCK}_sub${SUBSET}_${REMOVE}
