...
class MultilingualDatasetManager(object):
    ...
    def load_denoise_langpair_dataset(
        ...
        dataset = TokenBlockDataset(
            ...
            pad=mono_dict.pad(),
            eos=mono_dict.eos(),
            break_mode=self.args.sample_break_mode_mt,
        )
        ...
        **extra_kwargs,
        ...
        if data_category == "mono_dae":
            ...
            langpair_ds = self.load_langpair_dataset(
                ...
                src_lang=self.get_source_dictionary(src).index(f"__{src}__"),
                tgt_lang=self.get_source_dictionary(tgt).index(f"__{tgt}__"),
            )
