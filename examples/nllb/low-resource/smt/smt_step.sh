#!/bin/bash
STEP=${1}
# BILINGUAL_DIR=${2:-/checkpoint/haoranxu/SSL/data/bilingual/eng_tum.8k}
# MULTILINGUAL_DIR=${3:-/checkpoint/haoranxu/SSL/data/bilingual/eng_tum.8k}
# MONOLINGUAL_DIR=${4:-/checkpoint/haoranxu/SSL/data/monolingual/for_low_resource}
# LANGS=${5:-tum,eng}
# VOCAB_SIZE=${6:-8000}
# OUT_DIR=${7:-/checkpoint/haoranxu/SSL/data/mose_data/mose_data.8k}
# PARTITION=${8:-devlab}

BILINGUAL_DIR=${2:-/checkpoint/haoranxu/SSL/data/multilingual/m8_32k}
MULTILINGUAL_DIR=${3:-/checkpoint/haoranxu/SSL/data/multilingual/m8_32k}
MONOLINGUAL_DIR=${4:-/checkpoint/haoranxu/SSL/data/monolingual/m8_32k_raw/raw/}
LANGS=${5:-fuv,kmb,lug,nya,umb,wol,eng}
VOCAB_SIZE=${6:-32000}
OUT_DIR=${7:-/checkpoint/haoranxu/SSL/data/mose_data/m8_32k}
PARTITION=${8:-devlab}
