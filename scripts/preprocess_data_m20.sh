LANGS=nso,run,ssw,ind,msa,isl,nob,fao,slv,tgl,cat,glg,fur,ltz,lim
OUT_MULTI=/checkpoint/haoranxu/SSL/data/multilingual/m15_32k
OUT_MONO=/checkpoint/haoranxu/SSL/data/monolingual/m15_32k
